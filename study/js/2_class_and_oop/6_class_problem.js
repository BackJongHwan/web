...
// const ive = new IdolGroup('ive', iveMembers.map(x => FemaleIdol(x.name, x.year)));
// const bts = new IdolGroup('bts', btsMembers.map(x => MaleIdol(x.name, x.year)));
// const korea = new Country('Korea',[ive,bts] );
